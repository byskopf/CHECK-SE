...
Todas as mudanças relevantes do PWA CHECK-SE serão registradas neste arquivo.
O projeto usa versionamento semântico no formato `MAIOR.MENOR.CORREÇÃO` e tags no
formato `vX.Y.Z`.
