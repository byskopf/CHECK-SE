...
var CACHE_NAME = 'check-se-launcher-v7-20260904';
...
var APP_SHELL = [
  ...
  new URL('app.html', scopeBase).href,
      ...
      Promise.resolve(event.preloadResponse)
        ...
        .catch(function () {
          return caches.match(request.url).then(function (cached) {
            ...
            return caches.match(indexUrl).then(function (fallback) {
              return fallback || caches.match(new URL('offline.html', scopeBase).href);
            });
          });
        })
    );
